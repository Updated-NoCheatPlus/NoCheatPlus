...
### Output of the `ncp inspect [playername]` command for in-game issues

#### Short description of the issue and how to reproduce 
...
#### Do you use **client-side** mods that could interfere with vanilla game mechanics **_(such as Optifine's FastMath)_**?
